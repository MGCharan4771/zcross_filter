		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cross App Nav2",
									"targetURL": "#zcrossfilter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcrossfilter-display": {
								"semanticObject": "zcrossfilter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcrossfilter",
									"url": sap.ui.require.toUrl("zcrossfilter")
								}
							}
						}
					}
